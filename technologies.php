...
.slide-up-animation-mobile {
  opacity: 0;
  animation: slide-up-behind 0.5s forwards;
}
...
<div class="section col-lg-10 col-md-12 animate-on-scroll">
...
<div class="section col-lg-10 col-md-12 tecside_left animate-on-scroll">
  <div class="col-lg-6 content-section">
    ...
    function handleScroll() {
      ...
      elements.forEach(element => {
        ...
        if (rect.top < windowHeight && rect.bottom > 0) {
          if (isMobile) {
            element.classList.add('slide-up-animation-mobile');
          } else {
            element.classList.add('slide-up-animation');
          }
        } else {
          element.classList.remove('slide-up-animation', 'slide-up-animation-mobile');
        }
      });
    }
