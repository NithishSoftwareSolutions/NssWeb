    ...
    <h2 class="text-white text-center table-head">Full-time Candidates</h2>
         <div class="table-responsive">
          <table class="table table-striped">
            ...
            <tbody>
                <?php
                $sql = "SELECT name, role, certificate FROM reviews LIMIT $offsetFullTime, $recordsPerPage";
                $result = $conn->query($sql);
...
<div class="container mt-5">
    ...
    <div class="table-responsive">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                <?php
                $sql = "SELECT name, role, certificate FROM in_reviews LIMIT $offsetInternship, $recordsPerPage";
                $result = $conn->query($sql);
