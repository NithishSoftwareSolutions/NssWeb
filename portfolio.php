...
<section id="brands1">
    ...
    <div class="container">
        <div class="row">
            <div class="col"><a href="https://iott.co.in/" target="_blank"><img src="assets/img/Component 23.png" alt="..."  id="mainImage1"></a>
            <div id="related-content1" class="hidden">
            <!-- <img src="assets/img/s1.png" alt="Related Image" class="img-fluid">    -->
            </div>
            </div>
            <div class="col"><a href="#" target="_blank"><img src="assets/img/Component 24.png" alt="..." id="mainImage2"></a>
            <div id="related-content2" class="hidden">
            <!-- <img src="assets/img/s2.png" alt="Related Image" class="img-fluid">    -->
            </div>
            </div>

            <div class="col"><a href="#" target="_blank"><img src="assets/img/sign-in.png" alt="..." id="mainImage2"></a>
            <div id="related-content2" class="hidden">
            <!-- <img src="assets/img/s2.png" alt="Related Image" class="img-fluid">    -->
            </div>
            </div>
            ...
            <!-- <div class="col">
                <div class="card mt-3" id="cards1" style="height: 155px;margin-left:15%;" ><a href="#" target="_blank">
                    <div class="card-body">
                        <h5 class="card-title text-white text-center mt-5">NSS Groups</h5>
                    </div></a>
                    <div id="related-content3" class="col hidden">
                        <img src="assets/img/s3.png" alt="Related Image" class="img-fluid" id="mainImage3"  >   
                    </div>
                </div>
            </div> -->
        </div>
