...
<section id="shap" class="shap">
    <svg version="1.0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 762" preserveAspectRatio="none">
        ...
        <image width="720" height="500" href="assets/img/phone.png" />
    </svg>
</section>
...
<div class="container-fluid mt-5 custom-section">
    <div class="row">
        <div class="col-md-6 text-center">
            <img src="assets/img/phone.png" alt="IOTT App">
        </div>
...
<style>
    ...
    /* Apply animation to elements with class 'animate' */
    .card.animate {
...
<section id="section10" class="animate__animated animate__fadeInLeft animate__duration-2s animate__delay-10s">
        ...
        <div class="row mt-5 w-100">
            <div class="col-md-6 mx-auto">
                ...
                <a href="https://play.google.com/store/apps/details?id=iott.co.in" target="_blank">
                    <button type="button" class="btn btn-primary" id="">GET THE APP</button></a>
                </div>
            </div>
        </div>
    </div>
