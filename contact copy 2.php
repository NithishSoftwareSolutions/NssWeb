<!-- ======= Header ======= -->
   ...
   <style>
    ...
    <p class="Kindly">We are always willing to help you with our services</p>
</div>
        ...
        <div class="col-md-8 col-lg-6">
            <div class="contact-form">
                <form id="contact_form" method="POST" role="form">
                    ...
                    <div class="form-group">
                        <input type="email" name="email" class="form-control form-group12" placeholder="Your Email Address *" />
        ...
        $("form#contact_form").submit(function (event) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    $(".error").html(""); // Clear existing error messages
                    if (data.trim() === "ok") {
                        ...
                        $.each(form_errors, function (key, value) {
                            ...
                            if (value === "requirement_miss") {
                                $("#requirement_error").html("Requirement is required");
                            }
                        });
                    }
                },
