  ...
  <section>
    <div class="container-fluid ourpeople_banner mt-5 p-5">
      ...
      <div class="col-lg-2">
        ...
        <div class="col-lg-4 mt-5 animate-on-scroll" data-animation="fade-in">
        ...
        <div class="col-lg-4" >
        <img src="assets/img/70.png" class="img-fluid  mt-5 animate-on-scroll"  data-animation="zoom-in"alt="Profile Image" >
